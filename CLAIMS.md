...
| C5 | Decision bandwidth B(t) and praxitive Reynolds Re_prax provide interpretive turbulence diagnostics for TAP trajectories | (exploratory extension of TAP framework) | `simulator/turbulence.py`; `outputs/figures/turbulence_bandwidth.png` | exploratory |
