...
def main() -> None:
    ...
    run([sys.executable, 'skills/manuscript-report-builder/scripts/build_report_tables.py'])
    run([sys.executable, 'skills/figure-spec-enforcer/scripts/render_figures.py'])
    run([sys.executable, 'skills/claim-to-artifact-auditor/scripts/audit_claims.py'])
